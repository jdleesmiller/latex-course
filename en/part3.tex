%
% Delivery notes 1 May 2013:
% - people had forgotten more than I expected
% - only 8 students in the end, rather than 18, due to a meeting (and the sun
%   was shining)
% - the first exercise took about 30 mins
% - there was one person who had never used LaTeX, but she picked it up
%   surprisingly quickly; she had some programming experience (but she said she
%   wasn't very good at it)
% - common errors included:
%    - not putting in the maketitle & pagetitle commands; I tried to emphasise
%    these in the delivery, but apparently this did not have much effect
%    - missing end tags on environments -- very unhelpful error messages
%    - people not noticing the errors soon enough and then not knowing where the
%    problem was, making random changes, and then getting more confused
%    - case transposition errors
%    - substitution of letters for numbers (e.g. (O,O) instead of (0,0).
% - did not get to the TikZ stuff or todonotes, but some of the more advanced
%   students did try some of the early TikZ examples. 
% - switching between slides and wL seemed to confuse people; I think people's
%   retention was better when I just typed stuff in wL without reference to
%   slides. Flipping through the slides, even going very slowly and pointing at
%   each individual part of e.g. the columns environment did not seem to work
%   very well. What might be more effective would be a set of slides showing 
%   results, and then me typing in wL to achieve each result. 
% - the lab machines did not
% - some design ideas:
%   - on the right, the error stuff should by default take up the whole right
%   hand side -- OK to provide a close button, but very few people figured out
%   that they should hover over it for more info, and even fewer figured out
%   that 'go to first error' was a good thing to click when there was an error
%   - it should not say "error"; women in particular were quite flustered by
%   this; maybe 'oops', or 'minor problem' would be better
%   - faster preview would have helped; we were polling at 5s instead of 4s, and
%     there were noticeable delays at times, even with 16 renderers
%
