%
% Delivery Notes: 20 Feb 2013
%   - some people put stuff after \end{document}
%   - it's not entirely true that LaTeX ignores spacing in equation
%     environments: blank lines cause cryptic errors
%   - have to emphasise that you need pairs of dollar signs around math ---
%     maybe explain it in terms of how latex reads the document
%   - the 'interludes' didn't work especially well; I don't think people had
%     enough experience to see the patterns (or maybe I just didn't draw them
%     out enough)
%   - some people finished the exercises very quickly --- told them to go ahead
%     in the notes, which worked OK
%   - went too fast on the labels stuff; people did not seem to get that
%   - had to rush through graphics, tables and bibs
%   - the pdf link format did not work very well -- a lot of people retyped the
%     exercises without using them (and therefore did not get the hints)
%   - printing the notes worked very well -- a lot of people scribbled on them,
%     and having to switch between wL and slides was awkward.
%   - wL on a 4x3 screen wasn't great -- had to toggle between output and code,
%     so could not leave code up for students to copy -- a vertical split might
%     not be a bad idea, actually 
%   - people often did not find the error messages; and I should have done a
%     quick demo to show how to read an undefined control sequence error.
%
