...
\begin{itemize}
\item Use o pacote \bftt{biblatex}  com opções \bftt{style} para formatar as referências\footnote{O estilo \bftt{abnt} está disponível no TeXLive 2016.  \href{\fileuri/bib-example-abnt.pdf}{%
Veja exemplo aqui}.} e os \cmdbs{cite} e \cmdbs{textcite} para citar no texto.
\item Insira o comando \cmdbs{addbibresource} para incluir seu arquivo de referências e \cmdbs{printbibliography} para imprimir as referências.
\end{itemize}
