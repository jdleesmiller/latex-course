...
(ela pode  ``flutuar'').
\item Você pode colocar uma legenda para a figura usando \cmdbs{caption}, a qual pode ser referenciada  usando \cmdbs{ref}.
\end{itemize}
\begin{minipage}{0.55\linewidth}
\inputminted[fontsize=\scriptsize,frame=single,resetmargins]{latex}%
  {media-graphics.tex}
...
\end{itemize} 
\item Você também vai querer utilizar um editor para \LaTeX{}. Veja \url{en.wikipedia.org/wiki/Comparison_of_TeX_editors} para uma lista de opções.
