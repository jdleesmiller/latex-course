...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{\insertsubsection{} turbinado --- biblatex}
\begin{itemize}
\item Use o pacote \bftt{biblatex}  com opções \bftt{style} para formatar as referências\footnote{O estilo \bftt{abnt} do \bftt{biblatex}  está disponível somente a partir do TeXLive 2016.\href{\fileuri/bib-example-abnt.pdf}{%
Veja aqui exemplo formatado com abnt}.} e  \cmdbs{cite} e \cmdbs{textcite} para citar no texto.
