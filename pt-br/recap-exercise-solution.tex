...
\item vita equações. diz-se que por cada equação na tua apresentação, o número de pessoas que te compreendem passa para metade. Isto é, sendo q o número de equações na apresentação, o número de pessoas que percebem a apresentação é dado por:

\begin{equation}
n = \gamma \left( \frac{1}{2} \right)^q
\end{equation}

Onde $\gamma$ é a constante de proporcionalidade.
...
\item Fala para audiência e não para o ecrã. Um dos erros mais comuns é o orador falar virado de costas para audiência. 
...
\item Usa humor sempre que possível. È fascinante como uma piada seca consegue fazer as pessoas rir numa conferência cientifica.
