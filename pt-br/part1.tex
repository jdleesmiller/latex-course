...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Introdução ao LaTeX}
\framesubtitle{UFSC/Blumenau}

\begin{block}{Ministrantes}
\begin{itemize}
  \item Louise Reips (\href{mailto:l.reips@ufsc.br}{\texttt{l.reips@ufsc.br}})
  \item Luiz Rafael dos Santos (\href{mailto:l.r.santos@ufsc.br}{\texttt{l.r.santos@ufsc.br}})
  \item Naiara V. de Paulo Costa (\href{mailto:naiara.vergian@ufsc.br}{\texttt{naiara.vergian@ufsc.br}})
  \item Renan Gambale Romano (\href{mailto:r.g.romano@ufsc.br}{\texttt{r.g.romano@ufsc.br}})
\end{itemize}
\end{block}

\begin{block}{Minicurso terá 10h}
\begin{itemize}
  \item 15/Out: 8h às 12h
  \item 22 e 29/Out: 9h às 12h
\end{itemize}
\end{block}
\end{frame}
